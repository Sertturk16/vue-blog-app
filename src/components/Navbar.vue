<template>
  <nav class="navbar">
    ...
    <div class="links" v-if="!mobile">
        ...
        <router-link to="/create" v-if="$user.get().role === 'user'">Create</router-link>
        <router-link to="/login" v-if="$user.get().role === 'guest'">Login/Sign Up</router-link>
        <a v-if="$user.get().role === 'user'" @click.prevent="_logout()">Log Out</a>
    </div>
        ...
        >
          ...
          >
            ...
            <router-link exact to="/create" active-class="dojo-mobile-active">
              <v-list-item v-if="$user.get().role === 'user'">
            ...
            <router-link exact to="/login" active-class="dojo-mobile-active">
              <v-list-item v-if="$user.get().role === 'guest'">
                <v-list-item-title>Login/Sign Up</v-list-item-title>
              </v-list-item>  
            </router-link>
          
            <v-list-item v-if="$user.get().role === 'user'" @click="logout()">
